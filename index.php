...
<div class="col mx-auto">
    ...
    <div class="card">
        ...
        <span>Sign in with Google</span>
                ...
                <div class="form-body">
                    <form class="row g-3" action="home">
                        <div class="col-12">
                            <label for="inputEmailAddress" class="form-label">Email Address</label>
                            <input type="email" class="form-control" id="inputEmailAddress" placeholder="Email Address" value="">
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <button type="submit" class="btn btn-primary ">
                                <i class="bx bxs-lock-open"></i> <a href="home" style="color:white" class="btn"> Sign in</button>
                                </a>
                            </div>
                        </div>
                    </form>
