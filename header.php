...
<div class="user-box dropdown border-light-2">
	<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
		<img src="assets/images/my.jpg" class="user-img" alt="user avatar">
		<div class="user-info ps-3">
			<p class="user-name mb-0 text-white" >Tanveer Bin Samad</p>
			<p class="designattion mb-0">Professional Web Developer</p>
		</div>
	</a>
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li><a class="dropdown-item" href="index.php"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>
